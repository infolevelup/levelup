...
class TestController extends Controller
{
       ...
       public function index()
    {
        ...
        return view('user.test.index',compact('course'));
    }
    ...
    public function create()
    {
        //
         $data = Test::all();
            $course =Course::all();
            $lesson=Lesson::all();
        return view('user.test.create',compact('data','course','lesson'));
    }
...
//return $request->published;
    ...
    public function edit($id)
    {
        ...
        return view('user.test.edit',compact('data','course','lesson'));
    }
