...
<head>
  ...
  <title>Talk To Our Expert Form</title>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif;">
            <h1 style="font-size: 24px; margin: 0;">Talk To Our Expert Form
</h1>
          </td>
        </tr>
        <tr>
...
<table border="1" cellspacing="1" cellpadding="5">
					...
					<td>Date</td><td>:</td><td>{{$date}}</td>
							...
							<tr>
					<td>Message</td><td>:</td><td>{{$message2}}</td>
					</tr>	
						<tr>
					<td>Course Name</td><td>:</td><td>{{$course_name}}</td>
					</tr>	
						<tr>
					<td>Time to Call Back</td><td>:</td><td>{{$time_to_call_back}}</td>
					</tr>	
					</table>
@endif          </td>
        </tr>
