...
$course=App\Course::where('id',$course_id)->first();
    	$data = App\Course_student::where('user_id',$user_id)->where('course_id',$course_id)->first();
    ...
    <div class="pm-certificate-border col-xs-12">
      <div class="row pm-certificate-header">
        <div class="pm-certificate-title cursive col-xs-12 text-center">
          <h2>Level Up Certificate of Completion</h2>
        </div>
      </div>
            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="pm-earned col-xs-8 text-center">
                  ...
                  <span class="pm-credits-text block bold sans">Grade: {{$data->grade}}</span>
                </div>
                <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="pm-course-title underline col-xs-8 text-center">
                  <span class="pm-credits-text block bold sans">{{$course->title}}</span>
                </div>
                <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="pm-certificate-footer">
                ...
                <div class="col-xs-4 pm-certified col-xs-4 text-center">
                  ...
                  <span class="pm-empty-space block underline">{{$data->updated_at}}</span>
