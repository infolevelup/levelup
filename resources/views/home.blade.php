...
$course_purchase=App\Course_student::where('user_id',Auth::user()->id)->first();
             
             if($course_purchase){
                                $purchased_course=$course_purchase->course_id;
 
                          $crs_prcse=App\Course_student::where('user_id',Auth::user()->id)->get();
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('css/custom.css')}}">
   ...
   <body>
		...
		<div class="padding">		
			<div class="jquery_accordion_wrapper">
            				...
            				<div class="jquery_accordion_item">
            					<div class="jquery_accordion_title">Live Courses</div>
			    ...
			    ?>
            			...
            			?>
            				...
            				<div class="jquery_accordion_item">
            					<div class="jquery_accordion_title">Self-Paced Courses</div>
            					<div class="jquery_accordion_content">
            					    @foreach($crs_prcse as $crs)
			    <?php 
			     $crs_id=$crs->course_id;
                ...
                <?php 
                $random_course=App\Course::all()->random(6);
                ?>
				<div class="jquery_accordion_item">
					<div class="jquery_accordion_title">Recommended Courses</div>
					<div class="jquery_accordion_content">
    ...
    <div class="course-box01"> <h2>Self-Paced</h2>
    
	<div id="single_course_area">
	 </div>
	 </div>
	@endif
	
	<div class="slide_course_box">
	<h3>Next courses you should enroll</h3>
	...
	<div class="item">
        ...
        //$course_rating = $course->reviews->avg('rating');
          //  $total_ratings = $course->reviews()->where('rating', '!=', "")->get()->count();
             ...
             ?>
                <li>
                    <div class="text-center section-color-1"><img src="{{url('/')}}/public/uploads/course_images/{{$course->course_image}}"></div>
