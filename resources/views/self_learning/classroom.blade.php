                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
							...
							<iframe width="100%" height="400" src="https://www.youtube.com/embed/<?php echo $youtube_id_v['v'];?>" frameborder="0" allowfullscreen></iframe>	
                            	@endif
                            		...
                            		@if($lessonmedia->name=='embed')
                                							    
                                								
							
                              <iframe width="100%" height="400" src="{{$lessonmedia->url}}" title="YouTube video player"
  						frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  			
                            	@endif
                        
                                <!----------------Pdf-------------------------->    	
                            	@if( !empty( @$lessonmedia->name=='downloadable_files' ))
                                    <embed
                                    src="{{ URL::to('/') }}/public/uploads/downloadable_files/{{ @$lessonmedia->filename }}"
                                    style="width:1000px; height:700px;"
                                    frameborder="0"
                                >
                                   @endif
                                   
                                               	@if( !empty( @$lessonmedia->name=='add_pdf' ))
                                    <embed
                                    src="{{ URL::to('/') }}/public/uploads/lessons/pdf/{{ @$lessonmedia->filename }}"
                                    style="width:1000px; height:700px;"
                                    frameborder="0"
                                >
                                   @endif
                                    	@if( !empty( @$lessonmedia->name=='add_audio' ))
                                      <audio controls>
                                    <source src="{{ URL::to('/') }}/public/uploads/lessons/audio/mp3/{{ @$lessonmedia->filename }}"type="audio/mp3">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12">
                                  <?php 
                                $test=App\Test::where('lesson_id',1)->where('course_id',1)->first();
                                //dd($tset);
                                ?>
                                @if($test)
                                <button class="start" data-test_id="{{$test->id}}" data-course_id='1'>start test</button>
