        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              @endif
               <div class="ml-auto">
                <div id="sorting" class="border rounded p-1 m-1" style="padding:15px 0px;"> <span class="text-muted">Sort by course</span> <select name="sort" id="sortBy">
           ...
           <thead>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>{{$cours->title}}</td>
                                      <td> 
                                        <a href="{{ route('admin.purchased_course.edit',$user->id) }}" >{{$user->name}}</a>
                                      </td>
                                    <td>{{$user->email}}</td>
                                    <td>{{$user->phone}}</td>
                                   
                                    <td>
                                       <a href="{{ route('admin.purchased_course.show',$user->id) }}"class="btn btn-info"  
                                       title="course list" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-arrow-right" 
