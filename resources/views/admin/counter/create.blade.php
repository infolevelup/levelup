          ...
          <div class="box">
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('admin.counter.store') }}">
                @csrf
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                            <label for="productname">Number<span class="required">*</span></label>
                            <input type="number" name="countt" id="newsdate" class="form-control" value="{{old('newsdate')}}" placeholder="Enter description" />
                              ...
                              <label for="images">Choose Image <span class="required">*</span></label>
                                <div class="input-group">
                                  <div class="custom-file">
                                    <input type="file" name="images" class="custom-file-input" id="images" required>
