           ...
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              @endif
                   ...
                   <form method="post" action="{{ route('admin.bundle.store') }}"enctype="multipart/form-data">
                    @csrf
            ...
            <div class="row">
              <div class="col-md-9 col-sm-12">
                <div class="form-group">
                  <label>Course</label>
                  <select class="form-control select2 col-12" name="course_id[]" multiple required>
                                        <optgroup >
              ...
              <div class="col-md-3 col-sm-12">
                <div class="form-group">
                  <label>Or</label><br>
                  <a href="{{url('admin/courses')}}" target="_blank" class="btn btn-primary btn-sm scroll-click">Add Cousre</a>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-9 col-sm-12">
                <div class="form-group">
                  ...
                  <select class="form-control select2 col-12" name="category_id" required>
