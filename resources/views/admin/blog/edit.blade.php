          ...
          <div class="box">
           <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="{{url('admin/blog')}}" class="btn btn-success ">View Blog</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               ...
               <input type="hidden" id="id" value="{{$data->id}}"> 
                     ...
                     <div class="col-md-4 col-sm-12">
                      ...
                      <div class="form-group">
                            ...
                            <div class="form-group">
                            <label for="productname">Date <span class="required">*</span></label>
                            <input type="date" name="date" id="newsdate" class="form-control" value="{{$data->date}}" placeholder="Enter date"required  />
                           ...
                           <textarea name="description" class="form-control" id="editor3">{{$data->description}}</textarea>
                            ...
                            @endif
                             ...
                             <span>Note: Images size - w:690px by h:420px</span>
                            </div>
                                                    </div>
                                                                                    </div>
