...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Student Placed</li>
      </ol>
    </section>
          ...
          <div class="box">
           <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="{{route('admin.studentplaced.index')}}"  class="btn btn-success ">View Student Placed</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('admin.studentplaced.store') }}">
                @csrf
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              <label for="images">Choose Multiple Image <span class="required">*</span></label>
                                <div class="input-group">
                                  <div class="custom-file">
                                    <input type="file" name="imagess[]" class="custom-file-input" id="imagess" multiple>
