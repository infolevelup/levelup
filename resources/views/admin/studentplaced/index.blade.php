        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{route('admin.studentplaced.create')}}" class="btn btn-success ">Add Student Placed</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              @endif
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin.studentplaced.edit', $row->id) }}"   class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
