              ...
              @endif
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{@$row->answer}}</td>
                          <td >
                                <a href="{{ route('admin.faq.edit', $row->id) }}" class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
                        ...
                        <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.faq.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                          @csrf
                          @method('DELETE')
                        </form>
                      </td>
