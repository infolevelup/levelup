                 ...
                 <div class="row">
                    <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="qustion" id="mobile" value="{{$data->qustion}}" class="form-control" placeholder="Enter Question" required/>
                            @if ($errors->has('qustion'))
                                <span class="required">
                                    <strong>{{ $errors->first('qustion') }}</strong>
                                </span>
                            @endif  
                          </div>
                          <div class="col-12 form-group">
                            <label for="price">Enter Answer <span class="required">*</span></label>
                            <textarea name="answer" id="answer" class="textarea_editor  form-control border-radius-0" placeholder="Enter enter Answer" required/>
