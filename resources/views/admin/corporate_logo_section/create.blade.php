          ...
          <div class="box">
           <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="{{route('admin.corporate_logo_section.index')}}"  class="btn btn-success ">View Corporate</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('admin.corporate_logo_section.store') }}">
                @csrf
                 <div class="row">
                    <div class="col-sm-12">
                          <div class="form-group">
                            <label for="image">Logo <span class="required">*</span></label>
                          ...
                          <label for="chkNo">
                           ...
                           <div class="form-group">
                            <button id="submit" type="submit" class="btn btn-primary">Create Logo</button>
                          </div>
                    </div>
                 </div>
                </div>
