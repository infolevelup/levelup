...
@endif
   ...
   <form method="post" action="{{ route('admin.projects.update',$data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
        ...
        <div class="col-md-4 col-sm-12">
          ...
          <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                         ...
                         <input type="file" name="filenames[]" multiple value="" class="form-control" accept=".pdf,.doc,.xls, .xlsx">
                        </div>
                        @if($data->pdf)
