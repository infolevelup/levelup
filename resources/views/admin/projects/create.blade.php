          ...
          <div class="box">
           <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="{{url('admin/projects')}}" class="btn btn-success ">View Projects</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <div class="col-md-4 col-sm-12">
          ...
          <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                         ...
                         <input type="file" name="filenames[]" multiple value="" class="form-control" accept=".pdf,.doc,.xls, .xlsx" required>
                        </div>
                      </div>
