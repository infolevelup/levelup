        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{route('admin.banners.create')}}" class="btn btn-success ">Add Banners</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <!-- <td>{{@$row->content}}</td>-->
                      ...
                      <td>{{@$row->status}}</td>
                      <td>
                        <a href="{{ route('admin.banners.edit', $row->id) }}" class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
