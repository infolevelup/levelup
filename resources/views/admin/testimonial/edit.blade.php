          ...
          <div class="box">
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form method="post" action="{{ route('admin.testimonial.update',$data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="video" id="newsdate" class="form-control" value="{{$data->video}}" placeholder="Enter Video link" />
                            @if ($errors->has('video'))
                                <span class="required">
	...
	<iframe width="100%" height="250" src="{{$data->video}}" frameborder="0" allowfullscreen></iframe>
                            ...
                            @endif
                             ...
                             <label for="percentage">Description <span class="required">*</span></label>
                                <textarea placeholder="Enter Description" rows="5" class="form-control" name="long_desc">{{$data->long_desc}}</textarea>
