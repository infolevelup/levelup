          ...
          <div class="box">
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form method="post" action="{{ route('admin.questions.update',$data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
            ...
            <div class="row">
                <div class="col-md-12 form-group">
                    <label for="tests" class="control-label">Tests</label>
                            ...
                            @foreach($test as $row)
                                    <option value="{{$row->id}}"<?php if($row->id==$data->test_id){echo 'selected';}?>>{{$row->title}}</option>
