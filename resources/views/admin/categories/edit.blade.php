...
<section class="content-header">
  ...
  <input type="file" name="image" class="form-control" id="image" value="">
        ...
        <div class="col-md-4 col-sm-12">
                              ...
                              <img src="{{ URL::to('/') }}/public/uploads/images/{{ $data->icon }}" alt="" class="img-responsive" width="40%" />
         ...
         <div class="col-md-4 col-sm-12">
                <div class="form-group">
                  <label>Popular Category</label>
                                      <br>
    <input type="checkbox" name="popular"  id="image"  @if($data->popular=='1')checked @endif>
