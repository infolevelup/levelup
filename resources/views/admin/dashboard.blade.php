        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Unread Notification List </h3>
            ...
            <div class="box-body">
             ...
             @foreach(auth()->user()->unreadNotifications as $notification)
                ...
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">{!! $notification->data['data'] !!}</span>
                  <!-- Emphasis label -->
                  <small class="label label-danger"><i class="fa fa-clock-o"></i> {{ $notification->created_at }}</small>
