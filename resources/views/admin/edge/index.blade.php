      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!--  <a href="{{ route('admin.edge.create') }}" class="btn btn-success ">Add Edge</a>--->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
           ...
           <thead>
                            ...
                            @foreach($data as $row)   
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="{{ route('admin.edge.edit', $row->id) }}"class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
                    ...
                    <!--    <button form="resource-delete-{{ $row->id }}" class="btn btn-danger"><i class="icon-copy fa fa-trash" aria-hidden="true" color='red'></i></button>
                        <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.edge.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                          @csrf
                          @method('DELETE')
                        </form> --> 
                                    </td>
