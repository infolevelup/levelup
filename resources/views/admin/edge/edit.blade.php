...
@endif
                   ...
                   <form method="post" action="{{ route('admin.edge.update',$data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
               ...
               <input type="hidden" id="id" value="{{$data->id}}"> 
                     ...
                     <div class="col-md-4 col-sm-12">
                      ...
                      <div class="form-group">
                           ...
                           <textarea name="description" class="form-control" id="editor3">{{$data->description}}</textarea>
  ...
  <button type="submit"   class="btn btn-success">Submit</button>
                  ...
                  <hr>  
                     ...
                     <form enctype="multipart/form-data" method="post" action="{{url('admin/edge/addMoreEdge')}}">
                      @csrf
                      <input type="hidden" name="edge_id" value="{{$data->id}}">
                      <h3>Add More Edge</h3>
                      <div class="form-group">
                      ...
                      <br>
                      <div class="form-group">
                        <button id="submit" type="submit" class="btn btn-primary">Add Edges</button>
                      </div>
                    </form>
                    <hr>
                    <h3>Update Edge</h3>
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{$product_price->name}}</td>
                            <td width="30%"><img src="{{ URL::to('/') }}/public/uploads/{{$product_price->logo }}" alt="" class="img-responsive"  style="width:20%;"/></td>
                             <td>
                                <button form="resource-delete-{{ $product_price->id }}"><i style="color: red;" class="fa fa-trash"></i></button>
                              <form id="resource-delete-{{ $product_price->id }}" action="{{ url('admin/edge/deleteMoreEdge') }}/{{$product_price->id}}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                                @csrf
                              </form></td>
                          </tr>
                        @endforeach
