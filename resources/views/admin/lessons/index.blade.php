        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{ route('admin.lessons.create') }}"class="btn btn-success ">Add Lessons</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              @endif
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td colspan="3">
                                       ...
                                       <a href="{{ route('admin.lessons.edit', $row->id) }}" class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
                       ...
                       <!-- <button form="resource-delete-{{ $row->id }}" class="btn btn-danger " data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-trash" aria-hidden="true" color='red'></i></button>
                        <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.lessons.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                          @csrf
                          @method('DELETE')
                        </form>  -->
