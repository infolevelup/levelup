...
<input multiple class="form-control file-upload" id="downloadable_files" name="downloadable_files[]" type="file" accept="image/jpeg,image/png">
...
<div class="row">
<div class="col-md-12 form-group">
<label for="full_text" class="control-label">Downloadable Text</label>
<textarea class=" form-control border-radius-0"  placeholder="Enter full_tex ..." name="download_text"></textarea>
...
<div class="row">
<div class="col-md-12 form-group">
<label for="full_text" class="control-label">Pdf Text</label>
<textarea class=" form-control border-radius-0"  placeholder="Enter full_tex ..." name="pdf_text"></textarea>
