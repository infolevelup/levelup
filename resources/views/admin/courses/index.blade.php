 ...
 <section class="content-header">
    ...
    <section class="content">
     ...
     <thead>
                           ...
                           <?php   $new = \App\User::where('id',$row->teacher_id)->first(); 
                                ...
                                <tr>
                                  ...
                                  <td>{{$row->title}}</td>
                                    ...
                                    <td>
                                       ...
                                       <a href="{{ route('admin.courses.edit', $row->id) }}" class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
                      ...
                      <!--  <button form="resource-delete-{{ $row->id }}" class="btn btn-danger"data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-trash" aria-hidden="true" color='red'></i></button>
                        <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.courses.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                          @csrf
                          @method('DELETE')
                        </form>--->  
                                    </td>
