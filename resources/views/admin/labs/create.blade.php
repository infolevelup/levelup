           ...
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              @endif
                   ...
                   <form method="post" action="{{ route('admin.labs.store') }}"enctype="multipart/form-data">
                    @csrf
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="form-group">
          <div class="red box1"><input type="text" name="video1" placeholder="enter youtube link"class="form-control"></div>
    <div class="green box1"><input type="text" name="video2" placeholder="enter embed code"class="form-control"></div>
