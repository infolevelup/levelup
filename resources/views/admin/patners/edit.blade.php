          ...
          <div class="box">
           <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="{{route('admin.patners.index')}}"  class="btn btn-success ">View Partners</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              @endif
                   <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('admin.patners.update',$data->id) }}">
                @csrf
                @method('PATCH')
                <div class="container">
                 <div class="row">
                    <div class="col-sm-12">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            <button id="submit" type="submit" class="btn btn-primary">Update Partner</button>
                          </div>
                    </div>
                 </div>
                </div>
