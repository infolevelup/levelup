        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{route('admin.patners.create')}}" class="btn btn-success ">Add Partner</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              @endif
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="{{ URL::to('/') }}/public/uploads/images/{{ $row->image }}" alt="" class="img-responsive" width="50%" /></td>
                     
                      <td>
                        <a href="{{ route('admin.patners.edit', $row->id) }}" class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
                        ...
                        <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.patners.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                          @csrf
                          @method('DELETE')
                        </form>
                      </td>
