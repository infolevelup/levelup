          ...
          <div class="box">
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('admin.patners.store') }}">
                @csrf
                <div class="container">
                 <div class="row">
                    <div class="col-sm-12">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            <button id="submit" type="submit" class="btn btn-primary">Create Partner</button>
                          </div>
                    </div>
                 </div>
                </div>
