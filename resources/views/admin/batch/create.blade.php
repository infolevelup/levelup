...
@endif
                      ...
                      <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                          <label>Batch date</label>
                             ...
                             <input type="text" name="batch_date" class="form-control" id="datepicker">
             ...
             <div class="col-md-4 col-sm-12">
              ...
              <div class="col-md-4 col-sm-12">
                <div class="form-group">
                  <label>Course Batch</label><span>*</span>
                  <select  class="form-control" name="batch_days">
						<option value="weekend">Weekend</option>
						<option value="weekdays">Weekdays</option>
					</select>
                 <!--- <input type="text" name="batch_days"class="form-control">
    ...
    <input type="time" name="batch_timings" class="form-control timepicker" id="image">
