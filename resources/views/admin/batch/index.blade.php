        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{ route('admin.batch.create') }}" class="btn btn-success ">Add Batch</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
           ...
           <thead>
                            ...
                            @foreach($data as $row)   
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="{{ route('admin.batch.edit', $row->id) }}"class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
                        ...
                        <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.batch.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                          @csrf
                          @method('DELETE')
                        </form>  
                                    </td>
