                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Gender <span class="required" style="color:red">*</span></label><br>
                              <label for="chkYes">
                                <input type="radio" class="status" value="Male" name="gender" @if($data->gender == 'Male') checked @endif/>
                            ...
                            <label for="chkNo">
                                <input type="radio" class="status" value="Female" name="gender" @if($data->gender == 'Female') checked @endif />
                                @if ($errors->has('status'))
                                  <span class="required">
                                      <strong>{{ $errors->first('status') }}</strong>
                                  </span>
