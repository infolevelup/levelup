 ...
 <section class="content-header">
  ...
  <span class="slider round"></span>
                                    ...
                                    <td>
                                       ...
                                       <a href="{{ route('admin.teachers.edit', $row->id) }}"  class="btn btn-info"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
                       ...
                       <!-- <button form="resource-delete-{{ $row->id }}" class="btn btn-danger"><i class="icon-copy fa fa-trash" aria-hidden="true" color='red'></i></button>
                              <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.teachers.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                          @csrf
                          @method('DELETE')
                        </form>  -->
                        <a href="{{url('/admin/courselist')}}/{{$row->id}}" class="btn btn-warning" title="course List"><i class="icon-copy fa fa-eye" aria-hidden="true"></i></a>
