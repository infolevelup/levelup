                   ...
                   <form method="post" action="{{ route('admin.teachers.store') }}"enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">First Name <span class="required" style="color:red">*</span></label>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Email <span class="required" style="color:red">*</span></label>
                            <div class="col-sm-12 col-md-10">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Password <span class="required" style="color:red">*</span></label>
                            <div class="col-sm-12 col-md-10">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Gender <span class="required" style="color:red">*</span></label><br>
                              <label for="chkYes">
                                <input type="radio" class="status" value="Male" name="gender" checked="" />
                            ...
                            <label for="chkNo">
                                <input type="radio" class="status" value="Female" name="gender"/>
                                @if ($errors->has('status'))
                                  <span class="required">
                                      <strong>{{ $errors->first('status') }}</strong>
                                  </span>
