...
<head>
    ...
    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{url('/')}}/public/vendors/images/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{url('/')}}/public/vendors/images/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{url('/')}}/public/vendors/images/favicon-16x16.png">
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/public/src/plugins/datatables/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/public/src/plugins/datatables/css/responsive.bootstrap4.min.css">
...
<body>
    <div class="pre-loader">
        <div class="pre-loader-box">
            <div class="loader-logo"><img src="{{url('/')}}/public/vendors/images/deskapp-logo.svg" alt=""></div>
        ...
        <div class="header-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="notification-list mx-h-350 customscroll">
                            <ul>
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{url('/')}}/public/vendors/images/photo2.jpg" alt="">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{url('/')}}/public/vendors/images/photo3.jpg" alt="">
                                        <h3>John Doe</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{url('/')}}/public/vendors/images/photo4.jpg" alt="">
           ...
           <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
            ...
            <div class="github-link">
                <a href="https://github.com/dropways/deskapp" target="_blank"><img src="{{url('/')}}/public/vendors/images/github.svg" alt=""></a>
            </div>
        </div>
    </div>
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="{{url('admin/teachers')}}" class="dropdown-toggle no-arrow">
                            <span class="micon dw dw-edit2"></span><span class="mtext">Teachers</span>
                        </a>
                    </li>
                     <li>
                        <a href="{{url('admin/categories')}}" class="dropdown-toggle no-arrow">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-apartment"></span><span class="mtext">Course Management</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="{{url('admin/courses')}}">Course</a></li>
                            <li><a href="{{url('admin/lessons')}}">Lessons</a></li>
                            <li><a href="{{url('admin/test')}}">Test</a></li>
                            <li><a href="{{url('admin/questions')}}">Questions</a></li>
                        </ul>
                    </li>
                     <li>
                        <a href="{{url('admin/bundle')}}" class="dropdown-toggle no-arrow">
                           <span class="micon dw dw-house-1"></span><span class="mtext">Bundle</span>
                        </a>
                    </li>
                      <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-apartment"></span><span class="mtext">Site Management</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="{{url('admin/banners')}}">banners</a></li>
                            <li><a href="{{url('admin/testimonial')}}">Testimonial</a></li>
                            <li><a href="{{url('admin/patners')}}">Patners</a></li>
                            <li><a href="{{url('admin/counter')}}">Counter section</a></li>
                            <li><a href="{{url('admin/studentplaced')}}">Student placed</a></li>
                            <li><a href="{{url('admin/contacts/23/edit')}}">Contact</a></li>
                            <li><a href="{{url('admin/pages')}}">Pages Manager</a></li>
