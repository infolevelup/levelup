          ...
          <div class="box">
           <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="{{route('admin.grade.index')}}"  class="btn btn-success ">View Grade</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{route('admin.grade.store')}}">
                @csrf
                 <div class="row">
                    <div class="col-sm-12">
                          <div class="form-group">
                            <label for="price">Grade <span class="required">[A,B,C]*</span></label>
                            <input type="text" name="grade" id="mobile" class="form-control" placeholder="Enter grade" required/>
