...
<section class="content-header">
          ...
          <div class="box">
           <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a href="{{url('admin/test')}}"  class="btn btn-success ">View Test</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-12">
                <div class="form-group">
                  <label>Course</label>
                  <select class="form-control select2 col-6" name="course_id" required>
                                        <optgroup >
  ...
  @if ($errors->has('course_id'))
               ...
               <div class="col-md-6 col-sm-12">
                <div class="form-group">
                  <label>Lesson</label>
                  <select class="form-control select2 col-6" name="lesson_id" required>
                                        <optgroup >
                            <option>Please select lesson</option>
                            @foreach($lesson as $roww)
                                    <option value="{{$roww->id}}">{{$roww->title}}</option>
          ...
          <textarea class="textarea_editor form-control border-radius-0" placeholder="Enter text ..." name="description" id="editor1"></textarea>
