        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{route('admin.test.create')}}"class="btn btn-success ">Add Tests</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              @endif
                  ...
                  echo 'No';}?></td>
                      ...
                      <td>
                        <a href="{{ route('admin.test.edit', $row->id) }}"   class="btn btn-info" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fa fa-pencil" aria-hidden="true"></i></a>
                        ...
                        <form id="resource-delete-{{ $row->id }}" action="{{ route('admin.test.destroy', $row->id) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="post">
                          @csrf
                          @method('DELETE')
                        </form>
                      </td>
