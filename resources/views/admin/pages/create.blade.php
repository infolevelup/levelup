...
<section class="content-header">
          ...
          <div class="box">
           <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('admin.pages.store') }}">
                @csrf
        ...
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{url('/')}}/admin/pages"
                   class="btn btn-primary btn-sm scroll-click">View Pages</a>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="html-editor col-md-12 form-group">
                    ...
                    <textarea class="textarea_editor form-control editor" placeholder="" id="editor" name="content" cols="50" rows="10"></textarea>
  ...
  <div class="row">
                <div class="col-md-12 form-group">
                    ...
                    <input class="form-control" placeholder="icon" name="icon" type="text" id="meta_title">
            ...
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea class="form-control" placeholder="Meta Keywords" name="meta_keywords" cols="50" rows="10" id="meta_keywords"></textarea>
                </div>
                <div class="col-md-12 form-group">
            ...
            <div class="row">
                <div class="col-md-md-12 text-center form-group">
