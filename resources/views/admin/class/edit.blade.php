...
@endif
                 ...
                 <form method="post" action="{{ route('admin.class.update',$data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                        ...
                        <div class="form-group">
                          <label>Select Batch</label>
                            <select name="batch_id" class="form-control">
                                ...
                                <option value="{{$teacher->id}}" @if($data->batch_id==$teacher->id)selected @endif >{{$teacher->batch_name}}</option>
                                @endforeach
                            </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                          <label>Zoom link</label>
                             <input type="text" name="zoom_link" class="form-control" id="image" value="{{$data->zoom_link}}">
